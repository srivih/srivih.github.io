...
var WiresphereConfig = {
	Background: {
		SolidBg: {							
			Color: '#110f12'				// Solid background color
		},
		...
		Sphere3D: {
			...
			particleOpacity: 1,				// Opacity of particles
	...
	Colors: {
		...
		Tagline: {							// Tagline
			FirstLine: '#ea002a',			// Color of first line of tagline
			SecondLine: '#ffffff'			// Color of second line of tagline
		},
		
		Buttons: {							// Buttons
			Outline: '#ea002a',				// Color of buttons outline
